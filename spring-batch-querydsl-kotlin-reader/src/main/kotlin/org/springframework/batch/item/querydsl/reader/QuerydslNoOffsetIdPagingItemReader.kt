...
open class QuerydslNoOffsetIdPagingItemReader<T, N>(
    ...
    private val options: BaseNoOffsetNumberOptions<T, N>
    ...
    init {
        name = ClassUtils.getShortName(QuerydslNoOffsetIdPagingItemReader::class.java)
    }
